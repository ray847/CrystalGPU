#ifndef CRYSTALGPU_IMPL_GLAN_ARGUMENT_H_
#define CRYSTALGPU_IMPL_GLAN_ARGUMENT_H_

#include <format>
#include <string>

#include "code_gen/argument.h"
...
template <ANY_TYPE T>
class VAR<T, ARG> : public code_gen::ARG {
 public:
  using TYPE = T;
  /* Constructor */
  VAR() : code_gen::ARG(T::KEYWORD) {}
...
static_assert(semantic::ANY_VAR<VAR<TYPE::I32, ARG>>);
